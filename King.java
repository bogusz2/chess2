...
public class King extends Piece{
    ...
    private void setColor(Color c){
        if (color == Color.WHITE) {
            this.image = new Image( "file:///C:/Users/Gal Anonim/IdeaProjects/Figury/WhiteKing.png");

        } else {
            this.image = new Image( "file:///C:/Users/Gal Anonim/IdeaProjects/Figury/BlackKing.png");
