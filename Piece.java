...
abstract public class Piece {
    ...
    void checkNorth(Chessboard ch)
    {
        ...
        {
            if(ch.getSquares()[(int)positionPiece.getX()][(int)positionPiece.getY()-i].getPiece()==null) squaresToMove.add(new Point2D(positionPiece.getX(),positionPiece.getY()-i));
    ...
    void checkEast(Chessboard ch)
    {
        ...
        {
            if(ch.getSquares()[(int)positionPiece.getX()+i][(int)positionPiece.getY()].getPiece()==null) squaresToMove.add(new Point2D(positionPiece.getX()+i,positionPiece.getY()));
     ...
     void checkNorthEast(Chessboard ch)
    {
        ...
        {
            if(ch.getSquares()[(int)positionPiece.getX()+i][(int)positionPiece.getY()-i].getPiece()==null) squaresToMove.add(new Point2D(positionPiece.getX()+i,positionPiece.getY()-i));
